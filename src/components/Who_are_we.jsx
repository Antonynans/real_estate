...
const Who_are_we = () => {
  return (
    <main className="container mx-auto lg:py-24 lg:flex px-3 mb-12">
...
<div className="lg:block hidden">
      ...
      <div className="lg:w-2/5 flex items-end gap-4 lg:mt-0 mt-12 lg:h-auto h-[30rem]">
        <img
          src="/assets/demo.jpg"
          alt=""
          className="rounded-3xl w-1/2 h-4/5 shadow-md"
        />
        <div className="w-1/2 h-4/5 flex flex-col gap-4 relative -top-20">
          <img
            src="/assets/demo.jpg"
            alt=""
            className="w-full h-3/5 rounded-3xl shadow-md"
          />
          <img
            src="/assets/demo.jpg"
            alt=""
            className="w-full h-2/5 rounded-3xl shadow-md"
          />
